...
class Encoder:
    ...
    def board_string_to_int_array(board):
        int_array = []
        int_array_e = [0, 0, 0, 0, 0, 0]

        int_array_p = [1, 0, 0, 0, 0, 0]
        int_array_r = [0, 1, 0, 0, 0, 0]
        int_array_n = [0, 0, 1, 0, 0, 0]
        int_array_b = [0, 0, 0, 1, 0, 0]
        int_array_k = [0, 0, 0, 0, 1, 0]
        int_array_q = [0, 0, 0, 0, 0, 1]
    ...
    def board_to_int_array(board):
        ...
        encoded_board = np.array(Encoder.board_string_to_int_array(state)).reshape(1, 384)
